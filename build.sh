...
COMPONENTS="VersionOne.TFS2010.Common VersionOne.TFS2010.DataLayer VersionOne.TFS2010.Tests VersionOneTFSPolicy VersionOneTFSPolicyInstaller VersionOneTFSServer VersionOneTFSServerConfig"
...
MSBuild.exe $SOLUTION_FILE -p:Platform="Any CPU" -p:SignAssembly=$SIGN_ASSEMBLY -p:AssemblyOriginatorKeyFile=$WIN_SIGNING_KEY -p:RequireRestoreConsent=false
